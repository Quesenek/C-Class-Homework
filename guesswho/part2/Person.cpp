...
/*
 * printPerson prints the attributes of a person object
 * 
 * Return:  void
 */
void Person::printPerson()
{
    ...
    cout << right << setw(10) << hairColor;
    cout << right << setw(10) << hairType;
    cout << right << setw(10) << gender;
    cout << right << setw(10) << ((glasses == 1) ? "yes" : "no");
    cout << right << setw(10) << eyeColor;
    cout << right << setw(10) << ((hat == 1) ? "yes" : "no");
    cout << endl;
}
